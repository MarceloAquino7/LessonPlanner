...
export class HttpService implements IProvider {
  ...
  public get(url: string): Observable<APIResponse> {
    ...
    return Observable.create(observer => {
      this.http
        .get<APIResponse>(apiBaseURL + url)
        .subscribe(
          response => {
  ...
  public getByFilter(url: string, filter: object): Observable<APIResponse> {
  ...
  public post(url: string, data: any, options?: any): Observable<APIResponse> {
  ...
  public put(url: string, id: string, data: any, options?: any): Observable<APIResponse> {
